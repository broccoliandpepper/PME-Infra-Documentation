...
- User workstations (Windows 11, Azure AD joined)
...
- QNAP Remote Site: 172.16.211.10 (remote site replication)
...
4. **QNAP Primary Site → QNAP Remote Site**: SMB replication over VPN
...
- Historical NetApp storage (legacy phases)
...
- AI security appliances (management interface)
